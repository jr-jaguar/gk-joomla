 ...
 */
class StudentViewLists extends JView
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		$canDo	= StudentHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_STUDENT_TITLE_LISTS'), 'lists.png');
